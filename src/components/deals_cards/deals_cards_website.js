...
const Deals_cards = () => {
  ...
  return (
    ...
    >
      <p
        className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-12 md:mt-16 font-bold capitalize text-center px-4'
        data-aos='fade-up'
      >
        WebKooker's Affordable Pricing Plans
      </p>
      <p
        className='font-bold text-center max-w-2xl mx-auto mt-3 px-4 text-sm md:text-base'
        data-aos='fade-up'
      >
        We border on affordability, making it flexible for businesses to acquire
        a strong online presence.
      </p>
      <div className='flex flex-wrap justify-center items-center gap-6 p-4 md:p-10'>
        {plans.map((plan, index) => (
          <div
            key={index}
            className="relative group w-full sm:w-96 h-auto p-6 bg-white rounded-lg transform transition duration-300 ease-in-out bg-[url('/bg4.png')] bg-auto bg-repeat bg-right"
            data-aos='fade-up'
          >
